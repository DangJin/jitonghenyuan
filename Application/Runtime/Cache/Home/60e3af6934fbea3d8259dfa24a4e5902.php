        ...
        <div>
            ...
            <nav class="navbar navbar-inverse row visible-xs-sm-md-block hidden-lg" id="mobile_product">
                ...
                <div class="container-fluid col-md-8">
                    ...
                    <div class="navbar-header">
                        ...
                        <span class="navbar-brand" href="<?php echo U('Home/Example/index');?>">工程案例</span>
            ...
            <div class="index_product_title row hidden-xs  hidden-sm hidden-md">
                ...
                <div class="title col-md-12 hidden-xs  hidden-sm hidden-md" align="center">
                    ...
                    <strong>工程案例 | Construction Case</strong>
            ...
            <div class="product_img row" style="background: url(/jitonghenyuan/Public/static/images/bg_1.png);">
                ...
                <div class="product_img_goods col-md-8 row">
                    ...
                    <ol class="nav nav-pills nav-stacked col-md-2  hidden-xs  hidden-sm hidden-md">
                        ...
                        <li class="active"><a href="<?php echo U('Home/Example/index');?>"><strong>工程案例   <i class="fa fa-angle-down"></i></strong></a></li>

                        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li <?php if($id == $vo["id"]): ?>class="active"<?php endif; ?> ><a href="<?php echo U('Home/Example/index',array('id'=>$vo['id']));?>"><?php echo ($vo["name"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>

                    </ol>

                    <ul class="col-md-10 row" style="background: #fafafa">
                        ...
                        <li class="col-md-12 row">
                            ...
                            <div class="example_information col-md-6">
                                <div class="example_title"><strong><?php echo ($product["title"]); ?></strong></div>
                                <div class="example_type">产品类型： <?php echo ($product["type"]); ?></div>
                                <div class="example_code">项目编号： <?php echo ($product["proid"]); ?></div>

                            </div>
                            <div class="col-md-12 example_jieshao">
                                <div class="example_jieshao_title">项目介绍</div>
                                <div class="example_jieshao_content">
                                    <p><?php echo ($product["content"]); ?></p>
                                    <!--<p>该项目总占地面积为77,650平方米， 总建筑面积为231,591平方米， 包括新建4幢15层高的办公楼。</p>-->
                                </div>
                            </div>
                        </li>
