        ...
        <div class="row" style="background: url(/jitonghenyuan/Public/static/images/bg_1.png);">
            ...
            <div class="product_img_goods col-md-8 row">
                ...
                <ol class="nav nav-pills nav-stacked col-md-2  hidden-xs  hidden-sm hidden-md">
                    ...
                    <li class="active"><a href="<?php echo U('Home/news/index');?>"><strong>新闻资讯 <i class="fa fa-angle-down"></i></strong></a>
                    </li>
                    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li <?php if($id == $vo["id"]): ?>class="active"<?php endif; ?>><a href="<?php echo U('Home/news/index',array('id'=>$vo['id']));?>"><?php echo ($vo["name"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
                    <!--<li class="active">-->
                ...
                <div class="col-md-10 row news1_info_bg">
                    ...
                    <div class="col-md-12">
                        ...
                        <div align="center" style="margin-bottom: 20px">
                            <img src=<?php echo ($new["image"]); ?> class="img-responsive">
                        </div>
